...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-email-field', __webpack_require__(3));
  Vue.component('detail-email-field', __webpack_require__(6));
  Vue.component('form-email-field', __webpack_require__(9));
});
